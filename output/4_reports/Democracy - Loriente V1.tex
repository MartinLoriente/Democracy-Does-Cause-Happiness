...
\makeatother
\edef\savef{../2_figures/v1}
\edef\savet{../3_tables/v1}
...
Democracy is known to shape economic growth, public service delivery, and
the rule of law---but does it make ordinary people happier? Research
documents that democratic institutions promote economic growth, expand access
to public goods, and reduce infant mortality (\aaa{Acemoglu2019};
\aaa{Kudamatsu2012}). Yet it is far from obvious that these aggregate effects
translate into higher individual subjective well-being. The critical
intermediate link is income: if democracy improves lives primarily by raising
incomes, its effect on happiness depends on whether income gains translate
into lasting life satisfaction---a relationship that is itself deeply
contested (\aaa{Clark2014}). The Easterlin Paradox (\aaa{Easterlin1974};
\aaa{DiTella2008}; though see \aaa{StevensonWolfers2008}) documents that
rising national income does not reliably produce enduring improvements in
happiness, as inequality in the distribution of gains, rising aspirations,
and social comparisons can erode whatever psychological benefits material
progress delivers (\aaa{Clark2016}). Democracy may also affect well-being
through non-material channels (protecting civil liberties, reducing political
repression, and expanding individual agency), but whether these forces
generate measurable improvements in subjective welfare is equally unclear.
The question has direct policy relevance: any evaluation of democratic
governance must account for whether it genuinely improves the lives of those
living under it. Taken together, the theoretical priors are ambiguous: the
effect of democratic institutions on individual well-being is genuinely
uncertain, and ultimately an empirical question (\aaa{FreyStutzer2000}).

This paper provides a systematic answer. Using harmonized microdata from more
than 100 countries spanning four decades, I find that greater exposure to
democratic institutions robustly increases individual well-being across all
dimensions examined: income, health, personal autonomy, life satisfaction, and
happiness. A one-standard-deviation increase in lifetime democratic exposure
raises self-reported happiness by 0.14 standard deviations, with comparable
effects on income, health, autonomy, and life satisfaction. These estimates
are consistently positive and statistically significant for both continuous
and dichotomous measures of democracy and a wide range of alternative
specifications and clustering definitions.

The main empirical challenge is that wealthier, more stable societies tend
to be both more democratic and to report higher well-being, making a simple
cross-country comparison uninformative. The identification strategy exploits
variation in cumulative democratic exposure across birth cohorts within the
same country. Two individuals surveyed in the same country and year, but born
a decade apart, differ in the total years they spent under democratic rule to
the extent that their country’s democratic status changed over the years
between their births. Comparing such individuals while absorbing
time-invariant country characteristics and contemporaneous conditions through
country, birth-cohort, and survey-year fixed effects, with age included as
an additional control to address the standard age-period-cohort collinearity,
isolates the effect of democratic exposure from within-country cohort
variation. The strategy is validated by showing that democratic exposure
accumulated before birth, which cannot causally affect individual outcomes,
is uncorrelated with well-being. Democratic exposure is further instrumented
using regional democratization waves (\aaa{Acemoglu2019}), obtaining
estimates of similar sign and magnitude to those from the baseline strategy.
As exploratory evidence, I show that exposure during ages 18--25, when
institutional experiences are thought to leave lasting imprints
(\aaa{Krosnick1989}; \aaa{Dinas2013}; \aaa{Navajas2020}), is the window
most consistently associated with later well-being, a result interpreted as
suggestive rather than as an independent identification strategy.

The effects do not appear to operate exclusively through income. Comparing
individuals exposed to better- and worse-performing democracies (defined
along dimensions of economic growth, transparency, state capacity, and
redistribution) reveals that institutional quality substantially amplifies
democracy’s well-being gains. Importantly, however, positive effects persist
in lower-performing democracies relative to successful autocracies, pointing
to expanded freedoms and civic agency as independent contributors to
individual welfare (\aaa{Sen1999}).

This paper contributes to three literatures. A growing body of work
documents that democracy shapes macroeconomic aggregates---growth, inequality,
and fiscal capacity (\aaa{Acemoglu2019}; \aaa{Acemoglu2015})---but leaves
unanswered whether these aggregate effects improve individual welfare. This
paper provides the missing evidence, showing that democracy’s benefits extend
to personal happiness and life satisfaction at the individual level, extending
the within-context evidence of \bbb{FreyStutzer2000} to a global, causally
identified setting. It also contributes to the empirical literature on the
determinants of subjective well-being, which has focused primarily on income
(\aaa{Blanchflower2004}; \aaa{DiTellaMacCulloch2006}), employment, and
health, giving little attention to political institutions. The results show
that democratic institutions are a robust and quantitatively meaningful causal
determinant of well-being in a large and heterogeneous cross-country sample.
Finally, it extends the impressionable years literature (\aaa{Krosnick1989};
\aaa{Aksoy2020}; \aaa{Acemoglu2023}; \aaa{Navajas2020}), which documents
that institutional experiences during early adulthood shape long-run beliefs
and behaviors, by showing that this formative channel also operates on
well-being outcomes.
...
The timing of democratic exposure plays a central role in shaping long-term well-being. Table \ref{table2} presents a set of pairwise horse races in which the impressionable years measure is estimated jointly with a single alternative window---covering ages 2--9, 10--17, 26--33, 34--41, or cumulative lifetime exposure---entered as a control in each column. Table \ref{table3} examines the race between the impressionable years and lifetime exposure directly. Together, these tables show that exposure between ages 18 and 25 is the only period that consistently remains statistically significant across all specifications and outcomes. To ensure that the horse race is symmetric and equally demanding across all columns, the samples in columns (4) and (5) of Table \ref{table2} are restricted to respondents who have completed the full 8-year interval being controlled for: respondents aged 33 and older for the 26--33 window, and 41 and older for the 34--41 window---the same duration as the impressionable years measure itself (see table notes). This robustness indicates that early adulthood is the most consequential phase for the internalization of democratic norms and the formation of long-run preferences. While later adulthood windows (26--33 and 34--41) also display positive and occasionally sizable effects, their significance is less systematic across outcomes. These results suggest that democratic exposure throughout life contributes to well-being, but the impressionable years interval exerts a uniquely persistent and central influence.
		...
		\scalebox{0.57}{
			\begin{tabular}{lcccccc}\hline \hline
				...
				\multicolumn{7}{l}{\parbox{18cm}{\footnotesize \textbf{Notes:}
						Standard errors, robust to heteroskedasticity and serial correlation, are clustered at the country and survey-year levels and reported in parentheses. Results are shown for the continuous measure of democracy. *** Significant at the 1\% level; ** Significant at the 5\% level; * Significant at the 10\% level. All continuous outcomes and independent variables are normalized by their standard deviations. All regressions include fixed effects following our baseline specification: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. Each of these variables includes an additional category for missing values. Each column presents a pairwise horse race: Exposure to Democracy 18--25 is estimated jointly with a single alternative window as a control. Columns (1)--(3) and (6) use the full sample of respondents aged 25 and older. Columns (4) and (5) restrict to respondents aged 33 and older and 41 and older respectively, so that the control variable always covers a complete 8-year interval---the same duration as the impressionable years window. This ensures the horse race is symmetric and equally demanding across all columns. Lifetime exposure in column (6) accumulates from birth to the survey date and imposes no additional age restriction beyond the baseline. This table uses V-DEM (1911-2023) and IVS (1981-2022) datasets.}} \\
			\end{tabular}
		}
	\end{center}
\end{table}
...
\begin{table}[h!]
	\caption{V-Dem Component ETDs and Well-Being --- Impressionable Years (18--25)}
	\label{at21}
	\begin{center}
		\scalebox{0.75}{
			\begin{tabular}{lccccc}\hline \hline
				\ExpandableInput{\savet/header.tex}
				\hline \\
				\multicolumn{1}{l}{\textbf{Electoral Democracy}} \\
				\\
				\ExpandableInput{\savet/comppolyiy} \hline \\
				\multicolumn{1}{l}{\textbf{Liberal Component}} \\
				\\
				\ExpandableInput{\savet/complibiy} \hline \\
				\multicolumn{1}{l}{\textbf{Participatory Component}} \\
				\\
				\ExpandableInput{\savet/comppartipiy} \hline \\
				\multicolumn{1}{l}{\textbf{Deliberative Component}} \\
				\\
				\ExpandableInput{\savet/compdelibiy} \hline \\
				\multicolumn{1}{l}{\textbf{Egalitarian Component}} \\
				\\
				\ExpandableInput{\savet/compegaliy} \hline \\
				\multicolumn{6}{l}{\parbox{19.5cm}{\footnotesize \textbf{Notes:}
						Standard errors, robust to heteroskedasticity and serial correlation, are clustered at the country and survey-year levels and reported in parentheses. Each panel regresses the indicated outcome on the corresponding V-Dem component exposure during impressionable years (ages 18--25), constructed using the same ETD algorithm as the main exposure variables. Components are run in individual regressions, not simultaneously, to avoid multicollinearity. *** Significant at the 1\% level; ** Significant at the 5\% level; * Significant at the 10\% level. All continuous outcomes and independent variables are normalized by their standard deviations. All regressions include the baseline fixed effects: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. Sample restricted to respondents aged 25 or older. This table uses V-DEM (1911--2023) and IVS (1981--2022) datasets.
				}}
			\end{tabular}
		}
	\end{center}
...
\begin{table}[h!]
	\caption{V-Dem Component ETDs and Well-Being --- Horse Race, Impressionable Years (18--25)}
	\label{at22}
	\begin{center}
		\scalebox{0.75}{
			\begin{tabular}{lccccc}\hline \hline
				\ExpandableInput{\savet/header.tex}
				\hline \\
				\ExpandableInput{\savet/horses1c1iy} \hline \\
				\multicolumn{6}{l}{\parbox{19.5cm}{\footnotesize \textbf{Notes:}
						Standard errors, robust to heteroskedasticity and serial correlation, are clustered at the country and survey-year levels and reported in parentheses. All five V-Dem component exposures during impressionable years (ages 18--25) are included simultaneously. Due to the high correlation among components ($r > 0.70$), standard errors are large and coefficients are unstable; results should be interpreted with caution. *** Significant at the 1\% level; ** Significant at the 5\% level; * Significant at the 10\% level. All continuous outcomes and independent variables are normalized by their standard deviations. All regressions include the baseline fixed effects: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. Sample restricted to respondents aged 25 or older. This table uses V-DEM (1911--2023) and IVS (1981--2022) datasets.
				}}
			\end{tabular}
		}
	\end{center}
...
\begin{table}[h!]
	\caption{Descriptive Mediation --- Economic Growth and Institutional Quality Channels}
	\label{at23}
	\begin{center}
		\scalebox{0.75}{
			\begin{tabular}{lccccc}\hline \hline
				\ExpandableInput{\savet/header.tex}
				\hline \\
				\multicolumn{1}{l}{\textbf{Panel A: Lifetime Democracy (Baseline)}} \\
				\\
				\ExpandableInput{\savet/mechAs1c1lt} \hline \\
				\multicolumn{1}{l}{\textbf{Panel B: Lifetime Democracy + GDP Growth}} \\
				\\
				\ExpandableInput{\savet/mechBs1c1lt} \hline \\
				\multicolumn{1}{l}{\textbf{Panel C: Lifetime Democracy + Transparency + State Capacity}} \\
				\\
				\ExpandableInput{\savet/mechCs1c1lt} \hline \\
				\multicolumn{6}{l}{\parbox{19.5cm}{\footnotesize \textbf{Notes:}
						Standard errors, robust to heteroskedasticity and serial correlation, are clustered at the country and survey-year levels and reported in parentheses. Panel A reports baseline lifetime democracy estimates. Panel B adds contemporaneous GDP per capita growth (Maddison). Panel C adds a V-Dem transparency index (1 $-$ corruption score) and a state capacity baseline index. These regressions are descriptive rather than causal: mediators are outcomes of democracy, and their inclusion may introduce bad-control bias. This analysis is complementary to Tables 5 and 6, which provide the paper's primary mechanism evidence. *** Significant at the 1\% level; ** Significant at the 5\% level; * Significant at the 10\% level. All continuous outcomes and independent variables are normalized by their standard deviations. All regressions include the baseline fixed effects: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. This table uses V-DEM (1911--2023), Maddison, and IVS (1981--2022) datasets.
				}}
			\end{tabular}
		}
	\end{center}
...
\begin{table}[h!]
	\caption{Descriptive Mediation --- Health Investment Channel}
	\label{at24}
	\begin{center}
		\scalebox{0.75}{
			\begin{tabular}{lccccc}\hline \hline
				\ExpandableInput{\savet/header.tex}
				\hline \\
				\multicolumn{1}{l}{\textbf{Panel A: Lifetime Democracy (Baseline, Health-Expenditure Sub-Sample)}} \\
				\\
				\ExpandableInput{\savet/mechHAs1c1lt} \hline \\
				\multicolumn{1}{l}{\textbf{Panel B: Lifetime Democracy + Health Expenditure (\% GDP)}} \\
				\\
				\ExpandableInput{\savet/mechHBs1c1lt} \hline \\
				\multicolumn{6}{l}{\parbox{19.5cm}{\footnotesize \textbf{Notes:}
						Standard errors, robust to heteroskedasticity and serial correlation, are clustered at the country and survey-year levels and reported in parentheses. Both panels are estimated on the sub-sample of country-years with available health expenditure data (World Bank SH.XPD.CHEX.GD.ZS, 2000--2021). Panel A reports baseline lifetime democracy estimates in this sub-sample for comparability. Panel B adds contemporaneous total health expenditure as a share of GDP. These regressions are descriptive rather than causal: health expenditure is an outcome of democracy, and its inclusion may introduce bad-control bias. *** Significant at the 1\% level; ** Significant at the 5\% level; * Significant at the 10\% level. All continuous outcomes and independent variables are normalized by their standard deviations. All regressions include the baseline fixed effects: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. This table uses World Bank WDI (2000--2021), V-DEM (1911--2023), and IVS (1981--2022) datasets.
				}}
			\end{tabular}
		}
	\end{center}
...
\begin{table}[h!]
	\caption{V-Dem Component ETDs and Well-Being --- Lifetime Exposure}
	\label{at25}
	\begin{center}
		\scalebox{0.75}{
			\begin{tabular}{lccccc}\hline \hline
				...
				\multicolumn{1}{l}{\textbf{Electoral Democracy}} \\
				\\
				\ExpandableInput{\savet/comppolylt} \hline \\
				\multicolumn{1}{l}{\textbf{Liberal Component}} \\
				\\
				\ExpandableInput{\savet/compliblt} \hline \\
				\multicolumn{1}{l}{\textbf{Participatory Component}} \\
				\\
				\ExpandableInput{\savet/comppartiplt} \hline \\
				\multicolumn{1}{l}{\textbf{Deliberative Component}} \\
				\\
				\ExpandableInput{\savet/compdeliblt} \hline \\
				\multicolumn{1}{l}{\textbf{Egalitarian Component}} \\
				\\
				\ExpandableInput{\savet/compegallt} \hline \\
				\multicolumn{6}{l}{\parbox{19.5cm}{\footnotesize \textbf{Notes:}
						Standard errors, robust to heteroskedasticity and serial correlation, are clustered at the country and survey-year levels and reported in parentheses. Each panel regresses the indicated outcome on the corresponding V-Dem component lifetime exposure (from age 6), constructed using the same ETD algorithm as the main exposure variables. Components are run in individual regressions, not simultaneously, to avoid multicollinearity. *** Significant at the 1\% level; ** Significant at the 5\% level; * Significant at the 10\% level. All continuous outcomes and independent variables are normalized by their standard deviations. All regressions include the baseline fixed effects: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. This table uses V-DEM (1911--2023) and IVS (1981--2022) datasets.
				}}
			\end{tabular}
		}
	\end{center}
...
\begin{figure}[h!]
	\caption{V-Dem Component ETDs and Well-Being --- Coefficient Plot (Impressionable Years)}
	\label{af11}
	\begin{center}
		\scalebox{1}{
			\includegraphics[width=0.95\textwidth]{\savef/FigComp/compiy}
		}
		\parbox{17cm}{{\scriptsize \textbf{Notes:}
				Each panel plots the coefficient (and 95\% confidence interval) from a separate regression of the indicated outcome on the corresponding V-Dem component exposure during impressionable years (ages 18--25). Components are constructed using the same ETD algorithm as the main exposure variables. Electoral, Liberal, Participatory, Deliberative, and Egalitarian correspond to V-Dem indices \texttt{v2x\_polyarchy}, \texttt{v2x\_liberal}, \texttt{v2x\_partip}, \texttt{v2xdl\_delib}, and \texttt{v2x\_egal}, respectively. Components are run in individual regressions, not simultaneously. Standard errors are clustered at the country and survey-year levels. All coefficients are standardized (beta coefficients). All regressions include the baseline fixed effects: gender, survey wave, birth cohort, age, language, town size, sub-region, country, and year of interview. Sample restricted to respondents aged 25 or older. This figure uses V-DEM (1911--2023) and IVS (1981--2022) datasets.
		}}
	\end{center}
\end{figure}
