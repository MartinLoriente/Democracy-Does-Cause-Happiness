...
***  Data sets included.
****  Data set: "ZA7503_v3-0-0.dta" - EVS Trend File 1981-2017.
...
**** STATA does not completely save the defined value labels for S021, probably due to the lengh of the value (>9).
...
clear all
if "`c(username)'" == "lorie" {
    cd "C:/Users/lorie/Dropbox/DemocracyAndCulture"
} 
else if "`c(username)'" == "gaston" {
    cd "/Users/gaston/Dropbox (Harvard University)/RA/Nicolas/DemocracyAndCulture"
}
global WVS_TF "raw\1survey\1ivs\How to get Ivs19812022\WVS_trends_3_0.dta" 
global EVS_TF "raw\1survey\1ivs\How to get Ivs19812022\ZA7503_v3-0-0.dta" 
global IVS "raw\1survey\1ivs\How to get Ivs19812022\Ivs19812022.dta"
...
91504112008 "  Kosovo [2008] " , modify ;
...
250524 "FR: Diplôma from selective"
...
********************************************************************************.
**** (4) Save data
*Antes de guardarla la adapto para que use el mismo formato que la base con la que se trabajaba antes. Para eso creo una variable country y dropeo las variables de EVS5.
*generate string_S002EVS = string(S002EVS)
*drop if string_S002EVS == "5"
ren (COW_NUM X048ISO X049A X002_02A V001A V002A S016) (country regionadm1d2 x049a countryb countrybf countrybm language)
label var country "Country/region"
foreach v of varlist country countryb countrybf countrybm language{
	ren `v' t0
	decode t0,g(`v')
	drop t0
}
gen regionadm1d1 = x048a_n1
replace regionadm1d1 = X048H_N1 if x048a_n1 == ".d"
gen regionadm2d1 = x048b_n2 
replace regionadm2d1 = X048I_N2 if x048b_n2 == ".d"
decode X048_EVS, generate(X048_EVSS)
decode X048WVS, generate(X048WVSS)
clonevar regionadm0 = X048_EVSS
replace regionadm0 = X048WVSS if X048_EVSS == "Not asked in survey"
drop X048_EVSS X048_EVS X048WVS X048WVSS x048a_n1 x048b_n2 
save "${IVS}"
