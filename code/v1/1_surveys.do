...
IVS se combina codigo de Stata con el excel "code/ReadSurveys.xlsx".
...
*A1. IVS
*=============================================================================*/
usezipped using "${g_ivs}/Ivs19812022.zip",clear

clear
gl file "${g_ivs}/Ivs19812022.zip"
gl wave "ivs"
...
import excel using "code/ReadSurveys.xlsx",clear sheet("Ivs") first case(l) 
...
replace townsize2 = 1 if townsize2 == 1 | townsize2 == 2
...
foreach c of varlist country countryb countrybm countrybf{
	...
	replace `c'="TURKIYE" if `c'=="TURKEY" //Canonical: align with V-Dem v14 name used in panelDem2
...
compress
savezipped using "${temp}/1_survey/ivs",replace
...
compress
sa "${temp}/1_survey/censusCountryYearbYear",replace
erase "temp0.dta"
...
compress
sa "${temp}/1_survey/censusCountryYear",replace

/*==============================================================================
*B3. COUNTRY
*=============================================================================*/
u "${temp}/1_survey/censusCountryYear",replace
keep country
duplicates drop
la da "Countries where a measure of democracy is required"
compress
sa "${temp}/1_survey/censusCountry",replace
erase "temp.dta"